...
class Vectors {
  ...
  async add(options: { vectorBoxId: string, text: string, metadata?: any }) {
  ...
  async update(options: { vectorBoxId: string, vectorId: string, text: string, metadata?: any }) {
  ...
  async delete(options: { vectorBoxId: string, vectorId: string }) {
  ...
  async retrieve(options: { vectorBoxId: string, vectorId: string }) {
  ...
  async search(options: { vectorBoxId: string, query: string }) {
